...
Phát hành tại [Releases](https://github.com/Mint/MintADB/releases) *(cập nhật sau khi push)*:
...
```bash
git clone https://github.com/Mint/MintADB.git
cd MintADB
```
...
Báo lỗi / đề xuất: [Issues](https://github.com/Mint/MintADB/issues)
